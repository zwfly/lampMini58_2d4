...
#line 13 "..\\Library\\StdDriver\\src\\acmp.c"
...
{
    if(u32NegSrc != (0xFFUL))
        ((ACMP_T *) (((uint32_t)0x40000000) + 0xD0000))->VREF = u32NegSrc;
    ((ACMP_T *) (((uint32_t)0x40000000) + 0xD0000))->CTL[u32ChNum] = (((ACMP_T *) (((uint32_t)0x40000000) + 0xD0000))->CTL[u32ChNum] & (~((0x1ul << (4)) | (0x1ul << (2))))) |
                          ((u32NegSrc != (0xFFUL) ? (0x1ul << (4)) : 0) | u32HysteresisEn | (0x1ul << (0)));
}
...
void ACMP_Close(ACMP_T *acmp, uint32_t u32ChNum)
{
    ((ACMP_T *) (((uint32_t)0x40000000) + 0xD0000))->CTL[u32ChNum] &= (~(0x1ul << (0)));
}
