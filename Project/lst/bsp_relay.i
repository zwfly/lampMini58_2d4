...
void Relay_toggle(void) {
	(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(1))) + ((0)<<2)))) = ~(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(1))) + ((0)<<2))));
}
uint8_t Relay_IsOn(void) {
	return (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(1))) + ((0)<<2))));
}
void Relay_set(uint8_t s) {
	if (s) {
		Relay_on();
