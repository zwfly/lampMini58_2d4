...
void Timer0_InitHard(void) {
	...
	SYS_ResetModule(((0x4<<24) | (2) ));

	 
	CLK_EnableModuleClock((( 1UL<<31)|( 1<<29)|( 7<<25)|( 8<<20)|( 0<<18)|( 0x0<<10)|( 0<<5)|( 2<<0)));

	 
	CLK_SetModuleClock((( 1UL<<31)|( 1<<29)|( 7<<25)|( 8<<20)|( 0<<18)|( 0x0<<10)|( 0<<5)|( 2<<0)), 0x00000700UL, 0);
