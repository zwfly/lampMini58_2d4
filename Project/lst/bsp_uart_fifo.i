...
#line 2 "..\\Bsp\\src\\bsp_uart_fifo.c"



static UART_T_M g_tUart0;
static uint8_t g_TxBuf0[1*64];  
static uint8_t g_RxBuf0[1*64];  



static UART_T_M g_tUart1;
static uint8_t g_TxBuf1[1*256];  
static uint8_t g_RxBuf1[1*256];  
...
static void UartVarInit(void) {
	...
	g_tUart0.uart = ((UART_T *) (((uint32_t)0x40000000) + 0x50000));  
	g_tUart0.pTxBuf = g_TxBuf0;  
	g_tUart0.pRxBuf = g_RxBuf0;  
	g_tUart0.usTxBufSize = 1*64;  
	g_tUart0.usRxBufSize = 1*64;  
	g_tUart0.usTxWrite = 0;  
	g_tUart0.usTxRead = 0;  
	g_tUart0.usRxWrite = 0;  
	g_tUart0.usRxRead = 0;  
	g_tUart0.usRxCount = 0;  
	g_tUart0.usTxCount = 0;  
	g_tUart0.SendBefor = 0;  
	g_tUart0.SendOver = 0;  
	g_tUart0.ReciveNew = 0;  



	g_tUart1.uart = ((UART_T *) (((uint32_t)0x40100000) + 0x50000));  
	g_tUart1.pTxBuf = g_TxBuf1;  
	g_tUart1.pRxBuf = g_RxBuf1;  
	g_tUart1.usTxBufSize = 1*256;  
	g_tUart1.usRxBufSize = 1*256;  
...
#line 333 "..\\Bsp\\src\\bsp_uart_fifo.c"
	...
	UART_EnableInt(_pUart->uart, (0x1ul << (1)));
...
static void UartIRQ(UART_T_M *_pUart) {
	...
	if (_pUart->uart->INTSTS & (0x1ul << (9))) {
		
		if (_pUart->usTxCount == 0) {
			 

			UART_DisableInt(_pUart->uart, (0x1ul << (1)));
			...
			(_pUart->uart->DAT = (_pUart->pTxBuf[_pUart->usTxRead]));
