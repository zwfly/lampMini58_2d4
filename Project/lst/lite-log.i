...
#line 1 "..\\utils\\inc\\lite-log_internal.h"
...
#line 22 "..\\utils\\inc\\lite-log_internal.h"
...
#line 23 "..\\utils\\inc\\lite-log_internal.h"
...
#line 24 "..\\utils\\inc\\lite-log_internal.h"
...
#line 25 "..\\utils\\inc\\lite-log_internal.h"



#line 35 "..\\utils\\inc\\lite-log_internal.h"
...
#line 20 "..\\utils\\src\\lite-log.c"
#line 21 "..\\utils\\src\\lite-log.c"

#line 32 "..\\utils\\src\\lite-log.c"
...
int LITE_hexdump(const char *title, const void *buff, const int len) {
	...
	do { int i; printf("%s", "+"); for(i = 0; i < strlen(header) - 4; ++i) { printf("-"); } printf("%s", "+"); printf("\r\n"); } while(0);
	printf("%s", header);
	printf("%s\r\n", "+" "-----------------------" "-----------------------" "-----------------------");
...
void LITE_syslog(const char *f, const int l, const int level, const char *fmt,
	...
	printf("[%s] %s(%d): ", lvl_names[level], f, l);
...
void LITE_openlog(const char *ident) {
	strncpy(logcb.name, ident, (7));
	logcb.name[(7)] = 0;
	logcb.priority = 0;
}

void LITE_closelog(void) {
	strncpy(logcb.name, "", (7));
	logcb.name[(7)] = 0;
	logcb.priority = 0;
}
...
void LITE_rich_hexdump(const char *f, const int l, const int level,
	...
	printf("[%s] %s(%d): ", lvl_names[LITE_get_loglevel()], f, l);
