                                  ...
                                  uint32_t u32DutyCycle)
{
    ...
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CLKPSC = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CLKPSC & ~((0xfful << (0)) << ((u32ChannelNum >> 1) * 8))) | (u8Prescale << ((u32ChannelNum >> 1) * 8));
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CLKDIV = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CLKDIV & ~((0x7ul << (0)) << (4 * u32ChannelNum))) | (u8Divider << (4 * u32ChannelNum));
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CTL = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CTL & ~(0x1ul << (31))) | ((0x1ul << (3)) << ((4 * u32ChannelNum)));

    if(u32DutyCycle == 0)
        *((volatile uint32_t *)((((uint32_t) & ((pwm)->CMPDAT0)) + u32ChannelNum * 4))) = 0;
    else
        *((volatile uint32_t *)((((uint32_t) & ((pwm)->CMPDAT0)) + u32ChannelNum * 4))) = u32DutyCycle * (u16CNR + 1) / 100 - 1;

    *((volatile uint32_t *)((((uint32_t) & ((pwm)->PERIOD0)) + (u32ChannelNum) * 4))) = u16CNR;
...
void PWM_Start (PWM_T *pwm, uint32_t u32ChannelMask)
{
    ...
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CTL |= u32Mask;
}
...
void PWM_Stop (PWM_T *pwm, uint32_t u32ChannelMask)
{
    ...
    for(i = 0; i < (6); i ++) {
        if(u32ChannelMask & (1 << i)) {
            *((volatile uint32_t *)((((uint32_t) & ((pwm)->PERIOD0)) + (i) * 4))) = 0;
        }
    }
...
{
    if(u32ChannelNum < 4) {
        ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->ADCTCTL0 = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->ADCTCTL0 & ~(((0x1ul << (3)) |
                                            (0x1ul << (2)) |
                                            (0x1ul << (1)) |
                                            (0x1ul << (0)) ) << (8 * u32ChannelNum))) | (u32Condition << (8 * u32ChannelNum));
    } else {
        ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->ADCTCTL1 = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->ADCTCTL1 & ~(((0x1ul << (3)) |
                                            (0x1ul << (2)) |
                                            (0x1ul << (1)) |
                                            (0x1ul << (0)) ) << (8 * (u32ChannelNum - 4)))) | (u32Condition << (8 * (u32ChannelNum - 4)));
    }
}
...
void PWM_DisableADCTrigger (PWM_T *pwm, uint32_t u32ChannelNum)
{
    if(u32ChannelNum < 4) {
        ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->ADCTCTL0 = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->ADCTCTL0 & ~(((0x1ul << (3)) |
                                            (0x1ul << (2)) |
                                            (0x1ul << (1)) |
                                            (0x1ul << (0)) ) << (8 * u32ChannelNum)));
    } else {
        ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->ADCTCTL1 = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->ADCTCTL1 & ~(((0x1ul << (3)) |
                                            (0x1ul << (2)) |
                                            (0x1ul << (1)) |
                                            (0x1ul << (0)) ) << (8 * (u32ChannelNum - 4))));
    }
}
...
{
    if(u32ChannelNum < 4) {
        ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->ADCTSTS0 |= (u32Condition << (8 * u32ChannelNum));
    } else {
        ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->ADCTSTS1 |= (u32Condition << (8 * (u32ChannelNum - 4)));
    }
}
...
{
    if(u32ChannelNum < 4) {
        return(((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->ADCTSTS0 & (u32Condition << (8 * u32ChannelNum)) ? 1 : 0);
    } else {
        return(((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->ADCTSTS1 & (u32Condition << (8 * (u32ChannelNum - 4))) ? 1 : 0);
    }
}
...
void PWM_EnableFaultBrake (PWM_T *pwm,
                           ...
                           uint32_t u32BrakeSource)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->BRKCTL = (u32LevelMask << (24)) | u32BrakeSource;
}
...
void PWM_ClearFaultBrakeFlag (PWM_T *pwm, uint32_t u32BrakeSource)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->BRKCTL = (0x1ul << (7));
}
...
void PWM_EnableOutput (PWM_T *pwm, uint32_t u32ChannelMask)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->POEN |= u32ChannelMask;
}
...
void PWM_EnableDeadZone (PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Duration)
{
    ...
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->DTCTL = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->DTCTL & ~((0xfful << (0)) << (8 * u32ChannelNum))) | (u32Duration << (8 * u32ChannelNum));
    
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CTL |= ((0x1ul << (24)) << u32ChannelNum);
}
...
void PWM_ClearDutyIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->INTSTS = ((0x1ul << (8)) << u32ChannelNum);
}
...
uint32_t PWM_GetDutyIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    return(((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->INTSTS & ((0x1ul << (8)) << u32ChannelNum) ? 1 : 0);
}
...
void PWM_ClearPeriodIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->INTSTS = ((0x1ul << (0)) << u32ChannelNum);
}
...
uint32_t PWM_GetPeriodIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    return(((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->INTSTS & ((0x1ul << (0)) << u32ChannelNum) ? 1 : 0);
}
...
void PWM_ClearRiseIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->INTSTS = ((0x1ul << (24)) << u32ChannelNum);
}
...
uint32_t PWM_GetRiseIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    return(((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->INTSTS & ((0x1ul << (24)) << u32ChannelNum) ? 1 : 0);
}
...
void PWM_EnableFaultBrakeInt (PWM_T *pwm, uint32_t u32BrakeSource)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->INTEN |= (0x1ul << (16));
}
...
void PWM_ClearFaultBrakeIntFlag (PWM_T *pwm, uint32_t u32BrakeSource)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->INTSTS = u32BrakeSource;
}
...
uint32_t PWM_GetFaultBrakeIntFlag (PWM_T *pwm, uint32_t u32BrakeSource)
{
    return (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->INTSTS & u32BrakeSource ? 1 : 0);
}
...
void PWM_EnableCenterInt (PWM_T *pwm, uint32_t u32ChannelNum,  uint32_t u32IntPeriodType)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->INTEN = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->INTEN & ~(0x1ul << (17)) & ~((0x1ul << (18)) << u32ChannelNum)) | ((0x1ul << (18)) << u32ChannelNum) | u32IntPeriodType;
}
...
void PWM_DisableCenterInt (PWM_T *pwm, uint32_t u32ChannelNum)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->INTEN &= ~((0x1ul << (18)) << u32ChannelNum);
}
...
void PWM_ClearCenterIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->INTSTS = ((0x1ul << (18)) << u32ChannelNum);
}
...
uint32_t PWM_GetCenterIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    return(((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->INTSTS & ((0x1ul << (18)) << u32ChannelNum) ? 1 : 0);
}
