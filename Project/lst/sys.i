...
uint32_t SYS_GetBODStatus(void)
{
    return (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL & (0x1ul << (6)))?1:0;
}
...
uint32_t SYS_IsRegLocked(void)
{
    return !(((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->REGLCTL & (0xfful << (0)));
}
...
void SYS_ResetModule(uint32_t u32ModuleIndex)
{
    *(volatile uint32_t *)(&(((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST0) + (u32ModuleIndex>>24)) |= 1<<(u32ModuleIndex & 0x00ffffff);
    *(volatile uint32_t *)(&(((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->IPRST0) + (u32ModuleIndex>>24)) &= ~(1<<(u32ModuleIndex & 0x00ffffff));
}
...
{
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL &= ~(0x1ul << (0));
    ((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL = (((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL & ~(0x3ul << (1))) | (0x3ul << (1)) ;
}
