               ...
               uint32_t u32EnableWakeup)
{
    ...
    ((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->CTL = u32TimeoutInterval | (0x1ul << (7)) |
               (u32EnableReset << (1)) |
               (u32EnableWakeup << (4));
    ((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->ALTCTL = u32ResetDelay;
    return;
}
...
void WDT_EnableInt(void)
{
    ((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->CTL = (((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->CTL & ~((0x1ul << (3)) | (0x1ul << (5)) | (0x1ul << (2)))) | (0x1ul << (6));
    return;
}
...
void WDT_DisableInt(void)
{
    ((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->CTL &= ~((0x1ul << (3)) | (0x1ul << (5)) | (0x1ul << (2)) | (0x1ul << (6)));
    return;
}
